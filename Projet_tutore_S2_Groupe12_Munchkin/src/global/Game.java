	...
	public FightTab fight(Monster monster)
	{
		...
		switch (help)
		{
			case "OUI":
				...
				while (compare == 0)
				{
					System.out.println(FightTab.readPlayer().getPseudo() + ", Voulez-vous rajouter des bonus à vos dégâts ?");
					answer = sc1.nextLine();
					sc1.close();
					answer.toUpperCase();
					switch (answer)
				...
				while (compare == 0)
				{
					System.out.println(FightTab.readHelper().getPseudo() + ", voulez-vous rajouter des bonus à vos dégâts ?");
					answer = sc1.nextLine();
					sc1.close();
					answer.toUpperCase();
					switch (answer)
